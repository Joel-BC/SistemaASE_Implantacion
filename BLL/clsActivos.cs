...
namespace BLL
{
    public class clsActivos
    {
        ...
        public bool AgregarActivo(string codigoActivo, string nombreActivo, decimal costoActivo, int anno, int meses, string fechaActivo, bool estadoActivo)
        {
            try
            {
                int respuesta = 1;
        ...
        public bool ActualizarActivo(int IdActivo, string codigoActivo, string nombreActivo, decimal costoActivo, int anno, int meses, string fechaActivo, bool estadoActivo)
        {
            try
            {
                int respuesta = 0;
